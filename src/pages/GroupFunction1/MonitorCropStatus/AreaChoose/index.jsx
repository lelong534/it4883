      ...
      <div className="h-100 bg-white">
        <div className="row">
          <div className="col col-md-2">
            <h5 className="m-1">Chọn khu vực giám sát</h5>
            ...
            <a className="btn btn-primary mt-4" href="/monitor" >Giám sát cây trồng</a>
          </div>
          <div className="col col-md-10">
            <img className="w-100" src={IMAGES.areaDrone}></img>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div>
        <div className="custom-control custom-radio mt-2">
          ...
          />
          <label className="custom-control-label" for="customRadio1">Khu vực KV01</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          ...
          />
          <label className="custom-control-label" for="customRadio2">Khu vực KV02</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          ...
          />
          <label className="custom-control-label" for="customRadio3">Khu vực KV03</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio4" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio4">Khu vực KV04</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio5" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio5">Khu vực KV05</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio6" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio6">Khu vực KV06</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio7" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio7">Khu vực KV07</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio8" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio8">Khu vực KV08</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio9" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio9">Khu vực KV09</label>
        </div>
        <div className="custom-control custom-radio mt-2">
          <input type="radio" id="customRadio10" name="customRadio" className="custom-control-input" />
          <label className="custom-control-label" for="customRadio10">Khu vực KV10</label>
        </div>
      </div>
    );
  }
